                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><strong>Country:</strong><p runat="server" id="Country">United States</p>
                                </li>
                                <li class="list-group-item"><strong>State:</strong><p runat="server" id="State">California</p>
                                </li>
