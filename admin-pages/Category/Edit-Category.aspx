<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Edit-Category.aspx.cs" Inherits="CaterServ.admin_pages.Category.Edit_Category" %>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <asp:Button runat="server" ID="btn_login" class="btn btn-primary me-2" Text="Edit" OnClick="edit_category" />
